...
class LayoutlmEmbeddings(nn.Module):
    def __init__(self, config):
        ...
        self.position_embeddings = nn.Embedding(
            config.max_position_embeddings, config.hidden_siz
        )
...
class LayoutlmModel(BertModel):
    ...
    def forward(
        ...
        position_ids=None, head_mask=None, input_embeds=None,
...
class LayoutlmForTokenClassification(BertPreTrainedModel):
    ...
    def forward(
        self,
        input_ids, bbox,attention_mask=None, token_type_ids=None,
...
class LayoutlmForSequenceClassification(BertPreTrainedModel):
    ...
    def forward(
        self, input_ids, bbox, attention_mask=None,token_type_ids=None,
        position_ids=None, head_mask=None, inputs_embeds=None, labels=None,
    ):
        outputs = self.bert(
            input_ids=input_ids,
